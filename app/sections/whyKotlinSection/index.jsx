...
const ProgrammingLanguage = lazy(() =>
  import('./programmingLanguage').then((m) => ({ default: m.ProgrammingLanguage }))
);
...
const sections = [
  ...
  },
  {
    ...
    description: (
      <>
        Share application logic between web, mobile, and desktop platforms while keeping an
        experience native to users.
        <br />
        <br />
